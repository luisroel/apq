...
IF EXISTS (SELECT * FROM SYS.OBJECTS WHERE object_id = OBJECT_ID(N'spAPQ_Rpt_Stops') AND TYPE in (N'P'))
    DROP PROCEDURE [dbo].[spAPQ_Rpt_Stops]
GO
CREATE    PROCEDURE [dbo].[spAPQ_Rpt_Stops]
	    @IdRuntime		BIGINT
	  , @Area			INT
	  , @Line			INT
