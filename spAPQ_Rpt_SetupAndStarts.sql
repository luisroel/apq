...
IF EXISTS (SELECT * FROM SYS.OBJECTS WHERE object_id = OBJECT_ID(N'spAPQ_Rpt_SetupAndStarts') AND TYPE in (N'P'))
    DROP PROCEDURE [dbo].[spAPQ_Rpt_SetupAndStarts]
GO
CREATE    PROCEDURE [dbo].[spAPQ_Rpt_SetupAndStarts]
	    @IdRuntime		BIGINT
	  , @Area			INT
	  , @Line			INT
