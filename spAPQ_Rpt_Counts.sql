...
IF EXISTS (SELECT * FROM SYS.OBJECTS WHERE object_id = OBJECT_ID(N'spAPQ_Rpt_Counts') AND TYPE in (N'P'))
    DROP PROCEDURE [dbo].[spAPQ_Rpt_Counts]
GO
CREATE    PROCEDURE [dbo].[spAPQ_Rpt_Counts]
	    @IdRuntime		BIGINT
	  , @Area			INT
	  , @Line			INT
